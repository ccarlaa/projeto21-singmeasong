...
describe("top recommendations page test suite", () => {
    it("should return top recommendations", () => {
        const amount = 10
        cy.intercept("GET", `/recommendations/top/${amount}`).as("getTopRecommendations");
...
describe("random recommendations page test suite", () => {
